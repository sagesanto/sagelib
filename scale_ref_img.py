...
parser.add_argument("ref_image_input_path", type=str, required=True, help="Path to the reference image fits file")
...
parser.add_argument("ref_image_output_path", type=str, required=True, help="Path to the reference image output file")
