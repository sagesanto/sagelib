...
try:
    ...
    from .pipeline_db.models import Product, PipelineRun, TaskRun, Metadata, ProductGroup
except ImportError:
...
_all.extend(["Product","PipelineRun","TaskRun","Metadata","ProductGroup","configure_db"])
