...
from sagelib.testing import TEST_DATA_PATH, TEST_CALIB_PATH, TEST_DIR, TEST_CONFIG_PATH
...
p = Popen([sys.executable, reduce.__file__, "TEST", TEST_DATA_PATH, outdir, "-f", "-c", TEST_CONFIG_PATH])
p.wait()